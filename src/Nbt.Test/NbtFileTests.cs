...
namespace Nbt.Test {
    ...
    public class NbtFileTests {
        ...
        public void SaveToBuffer() {
            var littleTag = new CompoundTag("Root");
        ...
        public void PrettyPrint() {
            ...
            Assert.Throws<ArgumentNullException>(() => Tag.DefaultIndentString = null);
        }
        ...
        public void GlobalsTest() {
            Assert.AreEqual(NbtFile.DefaultBufferSize, new NbtFile(new CompoundTag("Foo")).BufferSize);
            ...
            NbtFile tempFile = new NbtFile(new CompoundTag("Foo"));
        ...
        public void RootTagTest() {
            CompoundTag oldRoot = new CompoundTag("defaultRoot");
            ...
            Assert.Throws<ArgumentException>(() => newFile.RootTag = new CompoundTag());
        ...
        public void NullParameterTest() {
            Assert.Throws<ArgumentNullException>(() => new NbtFile((CompoundTag)null));
