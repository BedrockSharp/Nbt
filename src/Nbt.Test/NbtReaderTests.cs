...
namespace Nbt.Test {
    ...
    public sealed class NbtReaderTests {
        ...
        public void PropertiesTest() {
            ...
            Assert.AreEqual(TagType.Compound, reader.TagType);
            Assert.AreEqual(TagType.Unknown, reader.ListType);
            ...
            Assert.AreEqual(TagType.Unknown, reader.ParentTagType);
            ...
            Assert.AreEqual(TagType.Int, reader.TagType);
            Assert.AreEqual(TagType.Unknown, reader.ListType);
            ...
            Assert.AreEqual(TagType.Compound, reader.ParentTagType);
            Assert.AreEqual(0, reader.ParentTagLength);
            Assert.AreEqual(0, reader.TagLength);
            ...
            Assert.AreEqual(TagType.List, reader.TagType);
            Assert.AreEqual(TagType.List, reader.ListType);
            Assert.IsFalse(reader.HasValue);
            Assert.IsFalse(reader.IsCompound);
            ...
            Assert.AreEqual(TagType.List, reader.TagType);
            Assert.AreEqual(TagType.Compound, reader.ListType);
            Assert.IsFalse(reader.HasValue);
            Assert.IsFalse(reader.IsCompound);
            Assert.IsTrue(reader.IsList);
            ...
            Assert.AreEqual(TagType.List, reader.ParentTagType);
            ...
            Assert.AreEqual(TagType.ByteArray, reader.TagType);
            Assert.AreEqual(TagType.Unknown, reader.ListType);
            Assert.IsTrue(reader.HasValue);
            Assert.IsFalse(reader.IsCompound);
            Assert.IsFalse(reader.IsList);
        ...
        public void ReadAsTagTest2() {
            ...
            {
                var reader = new NbtReader(new MemoryStream(testData));
                var root = (CompoundTag)reader.ReadAsTag();
        ...
        public void ReadListAsArray() {
            CompoundTag intList = TestFiles.MakeListTest();
            ...
            Assert.Throws<InvalidOperationException>(() => reader.ReadListAsArray<CompoundTag>());
        ...
        public void PartialBatchReadTest() {
            ...
            // Verifies fix for https://github.com/fragmer/Nbt/issues/26
        ...
        public void EndTagTest() {
            using (MemoryStream ms = new MemoryStream()) {
                ...
                Assert.AreEqual(TagType.End, reader.TagType);
                ...
                Assert.IsFalse(reader.HasName);
                Assert.IsFalse(reader.HasLength);
                Assert.Throws<InvalidOperationException>(() => reader.ReadAsTag()); // Cannot create Tag from TAG_END
