...
namespace Nbt {
    ...
    public sealed class NbtFile {
        ...
        /// RootTag will be set to an empty <c>CompoundTag</c> with a blank name (""). </summary>
        public NbtFile() {
        ...
        void LoadFromStreamInternal(Stream stream, TagSelector? tagSelector) {
            ...
            var rootCompound = new CompoundTag(reader.ReadString());
        ...
        /// <exception cref="NbtFormatException"> If one of the CompoundTag tags contained unnamed tags;
        /// or if an ListTag tag had Unknown list type and no elements. </exception>
        ...
        /// or if one of the CompoundTag tags contained unnamed tags;
        /// or if an ListTag tag had Unknown list type and no elements. </exception>
        ...
        static string GetRootNameInternal(Stream stream, bool bigEndian) {
            ...
            if (firstByte < 0) {
                throw new EndOfStreamException();
            } else if (firstByte != (int)TagType.Compound) {
                throw new NbtFormatException("Given NBT stream does not start with a TAG_Compound");
            }
