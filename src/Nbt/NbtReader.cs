...
namespace Nbt {
    ...
    public class NbtReader {
        ...
        /// and constructs an Tag object of the appropriate type. </summary>
        /// <returns> Constructed Tag object;
        ...
        public Tag ReadAsTag() {
            ...
            if (TagType == TagType.Compound) {
                ...
                // end tags cannot be read-as-tags (there is no corresponding Tag object)
        ...
        static void AddToParent(Tag thisTag, Tag parent) {
        ...
        /// Indents the tag according default indentation (Tag.DefaultIndentString). </summary>
