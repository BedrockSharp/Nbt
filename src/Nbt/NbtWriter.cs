...
namespace Nbt {
    ...
    public sealed class NbtWriter {
        ...
        /// <paramref name="elementType"/> is not a valid TagType. </exception>
        ...
        /// <summary> Writes a Tag object, and all of its child tags, to stream.
        /// Use this method sparingly with NbtWriter -- constructing Tag objects defeats the purpose of this class.
        /// If you already have lots of Tag objects, you might as well use NbtFile to write them all at once. </summary>
