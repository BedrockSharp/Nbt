...
namespace Nbt {
    ...
    public sealed class ByteArrayTag : Tag {
        ...
        /// <summary> Creates an unnamed ByteTag tag, containing an empty array of bytes. </summary>
        public ByteArrayTag()
            : this((string?)null) { }


        /// <summary> Creates an unnamed ByteTag tag, containing the given array of bytes. </summary>
        ...
        /// <summary> Creates an ByteTag tag with the given name, containing an empty array of bytes. </summary>
        ...
        /// <summary> Creates an ByteTag tag with the given name, containing the given array of bytes. </summary>
        /// <param name="tagName"> Name to assign to this tag. May be <c>null</c>. </param>
        /// <param name="value"> Byte array to assign to this tag's Value. May not be <c>null</c>. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is <c>null</c>. </exception>
        /// <remarks> Given byte array will be cloned. To avoid unnecessary copying, call one of the other constructor
        ...
        /// <summary> Creates a deep copy of given ByteArrayTag. </summary>
