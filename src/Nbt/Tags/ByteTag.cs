...
namespace Nbt {
    ...
    public sealed class ByteTag : Tag {
        ...
        /// <summary> Creates an unnamed ByteTag tag with the default value of 0. </summary>
        public ByteTag() { }


        /// <summary> Creates an unnamed ByteTag tag with the given value. </summary>
        /// <param name="value"> Value to assign to this tag. </param>
        public ByteTag(byte value)
            : this(null, value) { }


        /// <summary> Creates an ByteTag tag with the given name and the default value of 0. </summary>
        /// <param name="tagName"> Name to assign to this tag. May be <c>null</c>. </param>
        public ByteTag(string? tagName)
            : this(tagName, 0) { }


        /// <summary> Creates an ByteTag tag with the given name and value. </summary>
        /// <param name="tagName"> Name to assign to this tag. May be <c>null</c>. </param>
        /// <param name="value"> Value to assign to this tag. </param>
        ...
        /// <summary> Creates a copy of given ByteTag tag. </summary>
