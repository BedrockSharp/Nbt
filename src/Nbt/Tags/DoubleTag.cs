...
namespace Nbt {
    ...
    public sealed class DoubleTag : Tag {
        ...
        /// <summary> Creates an unnamed DoubleTag tag with the default value of 0. </summary>
        public DoubleTag() { }


        /// <summary> Creates an unnamed DoubleTag tag with the given value. </summary>
        /// <param name="value"> Value to assign to this tag. </param>
        public DoubleTag(double value)
            : this(null, value) { }


        /// <summary> Creates an DoubleTag tag with the given name and the default value of 0. </summary>
        /// <param name="tagName"> Name to assign to this tag. May be <c>null</c>. </param>
        public DoubleTag(string? tagName)
            : this(tagName, 0) { }


        /// <summary> Creates an DoubleTag tag with the given name and value. </summary>
        /// <param name="tagName"> Name to assign to this tag. May be <c>null</c>. </param>
        /// <param name="value"> Value to assign to this tag. </param>
        ...
        /// <summary> Creates a copy of given DoubleTag tag. </summary>
