...
namespace Nbt {
    ...
    public sealed class IntArrayTag : Tag {
        ...
        /// <summary> Creates an unnamed IntArrayTag tag, containing an empty array of ints. </summary>
        public IntArrayTag()
            : this((string?)null) { }


        /// <summary> Creates an unnamed IntArrayTag tag, containing the given array of ints. </summary>
        ...
        /// <summary> Creates an IntArrayTag tag with the given name, containing an empty array of ints. </summary>
        ...
        /// <summary> Creates an IntArrayTag tag with the given name, containing the given array of ints. </summary>
        /// <param name="tagName"> Name to assign to this tag. May be <c>null</c>. </param>
        /// <param name="value"> Int array to assign to this tag's Value. May not be <c>null</c>. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is <c>null</c>. </exception>
        /// <remarks> Given int array will be cloned. To avoid unnecessary copying, call one of the other constructor
        ...
        /// <summary> Creates a deep copy of given IntArrayTag. </summary>
