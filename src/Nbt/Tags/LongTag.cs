...
namespace Nbt {
    ...
    public sealed class LongTag : Tag {
        ...
        /// <summary> Creates an unnamed LongTag tag with the default value of 0. </summary>
        public LongTag() { }


        /// <summary> Creates an unnamed LongTag tag with the given value. </summary>
        /// <param name="value"> Value to assign to this tag. </param>
        public LongTag(long value)
            : this(null, value) { }


        /// <summary> Creates an LongTag tag with the given name and the default value of 0. </summary>
        /// <param name="tagName"> Name to assign to this tag. May be <c>null</c>. </param>
        public LongTag(string? tagName)
            : this(tagName, 0) { }


        /// <summary> Creates an LongTag tag with the given name and value. </summary>
        /// <param name="tagName"> Name to assign to this tag. May be <c>null</c>. </param>
        /// <param name="value"> Value to assign to this tag. </param>
        ...
        /// <summary> Creates a copy of given LongTag tag. </summary>
